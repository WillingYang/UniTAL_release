...
def valid_one_epoch(
    ...
    # # 准备 example_input，与 video_list 格式一致
    # example_input = [
    #     {
    #         "feats": torch.randn(2048, 2304),  # [C, T]
    #         "video_id": "video_001",
    ...
    #     if isinstance(item["feats"], torch.Tensor):
    #         item["feats"] = item["feats"].to(device)

    # # 使用 thop 计算整个模型的 FLOPs
    # macs, params = profile(model_to_profile, inputs=(example_input,), verbose=False)
    # flops = macs * 2  # 1 MAC = 2 FLOPs
    # print(f"模型 FLOPs: {flops / 1e9:.2f} GFLOPs")
    ...
    for iter_idx, video_list in enumerate(val_loader, 0):
        ...
        # if x1['video_id'] != 'video_test_0001447':
        #     #print(11111111111)
        #     continue
